<template>
    <div>
        ...
        <form class="form" v-if="!loggedIn">
            <div class="form-group">
                <label class="form-label" for="email">Email</label>
                <input type="text" v-model="$v.form.email.$model" :disabled="emailCheckedInDB"
                       placeholder="your@email.com" class="form-control" id="email">
                <div class="error info" v-if="emailCheckedInDB">
            ...
            <div class="form-group" v-if="emailCheckedInDB">
        ...
        if (!this.$v.form.email.$invalid) {
          ...
          return checkIfUserExistsInDB(this.form.email)
            .then(() => {
              ...
              this.emailCheckedInDB = true;
              this.$emit('updateAsyncState', 'error');
            });
        } else {
